...
<div id="killPhoneModal" class="container" >
    <form role="form" class ="text-center" method="post" action="/book/add">
        <div class="form-group">
            ...
            <input type="text" class ="text-center" style="width:30%" size="4" name="name" id="name" value="${book.name}" placeholder="">
        </div>
        <div class="form-group">
            <label for="name" >库存：</label>
            <input type="text" class ="text-center" style="width:30%" size="4" name="number" id="number" value="${book.number}" placeholder="">
        </div>
        <div class="form-group">
            <label for="name">描述：</label>
            <input type="text" class ="text-center" style="width:30%" size="4" name="desc" id="desc" value="${book.desc}" placeholder="">
        </div>
